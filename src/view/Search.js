...
import { View, Text, StyleSheet, StatusBar, TouchableOpacity, FlatList, Image, TextInput, ScrollView } from 'react-native'
...
const Search = () => {
    return (
        <ScrollView style={{ flex: 1, backgroundColor: '#fff' }} nestedScrollEnabled={true}>
